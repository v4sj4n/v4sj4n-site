...
export default function ContactForm() {
	return (
		<div className="relative rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 bg-white dark:bg-neutral-900/50 p-8 md:p-10">
			...
			<form action={submitContact} className="space-y-8">
				{[
					{
						label: "Name",
						name: "name",
				...
				>
					<motion.button
						...
						whileTap={{ scale: 0.99 }}
						className="group w-full py-4 mt-4 flex justify-center items-center gap-3 bg-neutral-950 dark:bg-white text-white dark:text-neutral-950 rounded-xl text-[13px] font-semibold tracking-wide hover:bg-primary dark:hover:bg-primary dark:hover:text-white transition-all duration-500"
					>
						Send Message
						<Send
							size={14}
