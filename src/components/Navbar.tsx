...
export default function Navbar() {
    ...
    return (
        <motion.header
            ...
            className={`fixed z-50 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${scrolled
                    ? `top-4 left-4 right-4 md:left-0 md:right-0 md:mx-auto max-w-2xl rounded-2xl backdrop-blur-2xl backdrop-saturate-150 border shadow-lg ${isLight
                ...
                <nav className="hidden md:flex items-center gap-1">
                    {navItems.map((item) => (
                        <a
                            ...
                            className={`relative px-4 py-2 text-[13px] font-medium tracking-wide transition-colors duration-300 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-800/50 ${isLight
